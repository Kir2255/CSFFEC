...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        uic.loadUi(R"G:\FEM-AoPB-master\FEM-AoPB-master\ui_layouts\mainwindow.ui", self)
    ...
    def __disable_parameters_frame(self) -> None:
        ...
        self.parametersFrame.setStyleSheet("color: black")
    ...
    def __create_fem(self) -> None:
        if self.__demo:
            self.__fem = FEM(800, 600, 2, 981, 208, 0.33, 10, 10)
        else:
